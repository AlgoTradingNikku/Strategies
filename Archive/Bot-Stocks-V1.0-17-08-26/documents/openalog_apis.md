...
| trigger\_price      | Trigger price (required for SL and SL-M orders)           | Optional           | 0             |
| disclosed\_quantity | Disclosed quantity for iceberg orders                     | Optional           | 0             |
...
* For **MARKET** orders, price and trigger\_price are not required
* For **LIMIT** orders, price is required
* For **SL** (Stop-Loss Limit) orders, both price and trigger\_price are required
* For **SL-M** (Stop-Loss Market) orders, only trigger\_price is required
